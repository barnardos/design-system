  ...
  <Page>
    ...
    <Main>
      <Content>
        <Title>{`Getting started`}</Title>
        <Paragraph>
          {`The Design System is for anyone creating digital products at Barnardo's. It provides consistency and familiarity for our service users by solving common problems with research.`}
        </Paragraph>
